...
class PatientHomeScreen extends StatefulWidget {
  ...
  static const routName = '/doctor_home_screen';
...
class _PatientHomeScreenState extends State<PatientHomeScreen> {
  var _myBox2 = Hive.box('patientBox');
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  CustomCard(
                    name: _myBox2.get('name'),
                    age: _myBox2.get('age'),
                    aadhar: _myBox2.get('aadharNumber'),
                    userName: _myBox2.get('userName'),
                  ),
                ],
              ),
              SizedBox(
